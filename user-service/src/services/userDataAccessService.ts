...
export class UserDataAccessService {
  ...
  async createUser(userData: CreateUserData): Promise<User> {
    try {
      // FIXED: Handle both null and undefined values consistently
      const result = await dbConnection.query(
        ...
        [
          ...
          userData.gitlab_id ?? null, // FIXED: Use nullish coalescing for consistency
          userData.display_name ?? userData.username, // Default to username if no display name
  ...
  async updateUser(
    ...
    try {
      ...
      // FIXED: Handle null values properly in updates
