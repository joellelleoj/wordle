...
|127.0.10.11:8082 -> /dev11/api
|link:https://gitlab.dit.htwk-leipzig.de/web-engineering-2025-wordle/wordle-api-gateway/-/tree/main/src/tests[Tests]
...
|link:https://gitlab.dit.htwk-leipzig.de/web-engineering-2025-wordle/wordle-game-service/-/tree/main/tests[Tests]
...
|link:https://gitlab.dit.htwk-leipzig.de/web-engineering-2025-wordle/wordle-user-service/-/tree/main/src/tests[Tests]
...
|link:https://gitlab.dit.htwk-leipzig.de/web-engineering-2025-wordle/database.git[Database Setup]
|Schema initialization, data migrations
|Internal: database-setup (one-time)
|
|===
...
* **Game History**: Complete record of all finished games
* **Personal Albums**: Organize completed games into customizable collections
